package com.imdb.process.info.config;
...
@EnableJpaRepositories(basePackages = "com.imdb.process.info.repositories")
public class PersistenceJPAConfig {
	...
	HibernateProperties hibernateProperties;
	   ...
	   public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
	      ...
	      em.setPackagesToScan(new String[] { "com.imdb.process.info.jpa.entities" });
